...
RSpec.describe YaKansuji::Formatter::Gov do
  ...
  it 'can convert number to kansuji' do
    ...
    expect(k(1_000_100_010_000)).to eq '1兆, 1億, 1万'

    expect(k(9_999_999)).to eq '999万, 9999'
    ...
    expect(k(111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111)).to eq '1111無量大数, 1111不可思議, 1111那由他, 1111阿僧祇, 1111恒河沙, 1111極, 1111載, 1111正, 1111澗, 1111溝, 1111穣, 1111𥝱, 1111垓, 1111京, 1111兆, 1111億, 1111万, 1111'
    expect(k(999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999_999)).to eq '9999無量大数, 9999不可思議, 9999那由他, 9999阿僧祇, 9999恒河沙, 9999極, 9999載, 9999正, 9999澗, 9999溝, 9999穣, 9999𥝱, 9999垓, 9999京, 9999兆, 9999億, 9999万, 9999'
  end
